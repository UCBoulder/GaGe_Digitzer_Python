...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setMinimumSize(QtCore.QSize(287, 375))
        self.groupBox.setMaximumSize(QtCore.QSize(287, 375))
        ...
        self.gridLayout.addWidget(self.le_buffersize, 1, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.le_savebuffersize, 2, 1, 1, 3)
        self.pb_gage_acquire = QtWidgets.QPushButton(self.groupBox)
        self.pb_gage_acquire.setObjectName("pb_gage_acquire")
        self.gridLayout.addWidget(self.pb_gage_acquire, 3, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.tb_monitor, 8, 0, 1, 4)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(126, 17, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
